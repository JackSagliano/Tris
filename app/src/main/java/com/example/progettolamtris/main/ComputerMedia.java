...
public class ComputerMedia extends AppCompatActivity {
        ...
        serverOffline.getPareggio().observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)) {
                    ...
                    Dialog dialog_pareggio = new Dialog(ComputerMedia.this);
        ...
        serverOffline.getVittoriag1().observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    ...
                    dialog_vittoria(ComputerMedia.this, true);
                }
            }
        });
        ...
        serverOffline.getVittoriag2().observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    ...
                    dialog_vittoria(ComputerMedia.this, false);
                }
            }
        });
