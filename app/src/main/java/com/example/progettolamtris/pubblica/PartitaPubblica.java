...
import com.example.progettolamtris.privata.NuovaPartitaPrivata;
...
public class PartitaPubblica extends AppCompatActivity {
    private ServerPubblica serverPubblica;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        serverPubblica = new ViewModelProvider(this, new ViewModelProvider.AndroidViewModelFactory(getApplication())).get(ServerPubblica.class);
        serverPubblica.setGiocatore1(nome_giocatore);
        serverPubblica.avvia_matchmaking(nome_giocatore);
        ...
        inizioPartita = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    ...
                    serverPubblica.isInizio_partita().removeObservers(PartitaPubblica.this);
                }
            }
        };
        ...
        turnoGiocatore = new Observer<String>() {
            ...
            public void onChanged(String s) {
                if(s.equals(nome_giocatore)){
                    ...
                    Log.d("è il turno del mio avversario", "è il turno del mio avversario");
                    mio_turno = false;
        ...
        getVittoriaTavolino = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    ...
                    vittoria_tavolino(PartitaPubblica.this, true);
                }
            }
        };
        ...
        getVittoriaGiocatore1 = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    cancelTimer();
                    serverPubblica.elimina_partita(serverPubblica.getNome_partita().getValue().toString());
                    dialog_vittoria(PartitaPubblica.this, true);
                }
            }
        };
        ...
        getVittoriaGiocatore2 = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    cancelTimer();
                    serverPubblica.elimina_partita(serverPubblica.getNome_partita().getValue().toString());
                    dialog_vittoria(PartitaPubblica.this, false);
                }
            }
        };
        ...
        getPareggio = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    ...
                    serverPubblica.elimina_partita(serverPubblica.getNome_partita().getValue().toString());
                    removeObservers();
                    Dialog dialog_pareggio = new Dialog(PartitaPubblica.this);
        ...
        getSconfittaTavolino = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    vittoria_tavolino(PartitaPubblica.this, false);
                }
            }
        };
        serverPubblica.isInizio_partita().observe(PartitaPubblica.this, inizioPartita);
        serverPubblica.getNome_partita().observe(PartitaPubblica.this, nomePartita);
        serverPubblica.getTurno_giocatore().observe(PartitaPubblica.this, turnoGiocatore);
        serverPubblica.ultima_mossa().observe(PartitaPubblica.this, ultimaMossa);
        serverPubblica.getVittoria_tavolino().observe(PartitaPubblica.this, getVittoriaTavolino);
        serverPubblica.getVittoriag1().observe(PartitaPubblica.this, getVittoriaGiocatore1);
        serverPubblica.getVittoriag2().observe(PartitaPubblica.this, getVittoriaGiocatore2);
        serverPubblica.getPareggio().observe(PartitaPubblica.this, getPareggio);
        serverPubblica.getSconfitta_tavolino().observe(PartitaPubblica.this,getSconfittaTavolino);
        for (int i = 0; i < caselle.size(); i++) {
            int finalI = i;
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        final Dialog dialog_abbandono = new Dialog(PartitaPubblica.this);
        int width = (int) (getResources().getDisplayMetrics().widthPixels * 1);
    ...
    public void abbandono(){
        ...
        serverPubblica.elimina_partita(serverPubblica.getNome_partita().getValue());
        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString("nome_utente", nome_giocatore);
        intent.putExtras(bundle);
