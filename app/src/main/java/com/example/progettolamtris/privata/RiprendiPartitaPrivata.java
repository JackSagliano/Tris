...
public class RiprendiPartitaPrivata extends AppCompatActivity {
    SingletonRiprendiPrivata singletonRiprendiPrivata = SingletonRiprendiPrivata.getSingletonRiprendiPrivata();
    private ServerRiprendiPrivata serverPrivata;
    ...
    Observer<String> partitaTrovata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("SONO DENTRO RIPRENDI PARTITA PRIVATA", "SONO DENTRO RIPRENDI PARTITA PRIVATA");
        serverPrivata = new ViewModelProvider(this, new ViewModelProvider.AndroidViewModelFactory(getApplication())).get(ServerRiprendiPrivata.class);
        serverPrivata.setNome_partita(nome_partita);
        serverPrivata.setPartita_trovata(nome_partita);
        ...
        partitaTrovata = new Observer<String>() {
            @Override
            public void onChanged(String s) {
                if(!s.equals("")){
                    serverPrivata.riprendi_partita();
                }
            }
        };
        inizioPartita = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    caselle_giocate = singletonRiprendiPrivata.getCaselle_g1();
                    caselle_giocate_avversario = singletonRiprendiPrivata.getCaselle_g2();
                    ...
                    serverPrivata.isInizio_partita().removeObservers(RiprendiPartitaPrivata.this);
                }
            }
        };
        turnoGiocatore = new Observer<String>() {
            ...
            public void onChanged(String s) {
                if(s.equals(nome_giocatore)){
                    ...
                    mio_turno = false;
                    serverPrivata.vittoria_tavolino_start();
        ...
        getSconfittaTavolino = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    cancelTimer();
                    vittoria_tavolino(RiprendiPartitaPrivata.this, false);
                }
            }
        };
        ...
        getVittoriaTavolino = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    cancelTimer();
                    vittoria_tavolino(RiprendiPartitaPrivata.this, true);
                }
            }
        };
        ...
        getVittoriaGiocatore1 = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    cancelTimer();
                    serverPrivata.elimina_partita(nome_partita);
                    dialog_vittoria(RiprendiPartitaPrivata.this, true);
                }
            }
        };
        getVittoriaGiocatore2 = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    cancelTimer();
                    serverPrivata.elimina_partita(nome_partita);
                    dialog_vittoria(RiprendiPartitaPrivata.this, false);
                }
            }
        };
        getPareggio = new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(aBoolean.equals(true)){
                    ...
                    removeObservers();
                    serverPrivata.elimina_partita(nome_partita);
                    Dialog dialog_pareggio = new Dialog(RiprendiPartitaPrivata.this);
        ...
        serverPrivata.getPartita_trovata().observe(RiprendiPartitaPrivata.this, partitaTrovata);
        serverPrivata.isInizio_partita().observe(RiprendiPartitaPrivata.this, inizioPartita);
        serverPrivata.getTurno_giocatore().observe(RiprendiPartitaPrivata.this, turnoGiocatore);
        serverPrivata.getSconfitta_tavolino().observe(RiprendiPartitaPrivata.this, getSconfittaTavolino);
        serverPrivata.getVittoria_tavolino().observe(RiprendiPartitaPrivata.this, getVittoriaTavolino);
        serverPrivata.ultima_mossa().observe(RiprendiPartitaPrivata.this, ultimaMossa);
        serverPrivata.getVittoriag1().observe(RiprendiPartitaPrivata.this, getVittoriaGiocatore1);
        serverPrivata.getPareggio().observe(RiprendiPartitaPrivata.this, getPareggio);
        for (int i = 0; i < caselle.size(); i++) {
            int finalI = i;
    ...
    public void onBackPressed() {
        final Dialog dialog_abbandono = new Dialog(RiprendiPartitaPrivata.this);
        int width = (int) (getResources().getDisplayMetrics().widthPixels * 1);
...
public void cancelTimer(){
    ...
    public void removeObservers(){
        ...
        serverPrivata.getPartita_trovata().removeObserver(partitaTrovata);
